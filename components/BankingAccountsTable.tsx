...
import { Edit, MoreHorizontal, Pencil, PlusSquare, TrashIcon } from 'lucide-react';
import { DataTableColumnHeader } from './datatable/ColumnHeader';
import { bankingAccountsType } from '@/db/schema/finance';
import { ResponsiveDialog } from './ui/responsive-dialog';
import EditBankingAccountDialog from './EditBankingAccountForm';
...
export function BankingAccountsTable({ data }: { data: bankingAccountsType[] }) {
